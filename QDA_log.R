...
qda_model_0 <-qda(diagnosis ~ .  -area_worst  -radius_mean - perimeter_mean - perimeter_worst-area_SE - concavity_mean -area_mean
...
err_0
drawparti(as.factor(wdbc_df$diagnosis)  ,radius_worst ,texture_worst ,method="qda", xlab = "radius_worst", 
          ylab = "texture_worst",imageplot = TRUE,col.wrong = "blue" , image.colors = c("lightgreen","indianred2"))
